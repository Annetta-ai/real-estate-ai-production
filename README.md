...
Before starting production, collect:

- Approved architectural CGI or source images
- Floor plans and architectural references
- Material, furniture, and landscaping references
- Client-approved camera views
- Brand and creative direction
- Required formats, aspect ratios, resolutions, and deadlines

### Recommended process

1. Review the source assets and define what must remain unchanged.
2. Select a template from the prompt library.
3. Adapt the prompt to the project and production tool.
4. Generate controlled image variations.
5. Apply the image quality gate.
6. Use only approved images for video generation.
7. Apply the video quality gate.
8. Export, document, and archive the final assets.

### Minimum documentation

Each approved asset should include:
